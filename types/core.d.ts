 ...
 */
export declare enum IntakeTerm {
    FALL = "Fall",
    SPRING = "Spring",
    SUMMER = "Summer",
    WINTER = "Winter"
...
export interface Program {
    ...
    tuitionFee?: FieldWithSource<string>;
    ...
    indianAcademicReq?: FieldWithSource<string>;
    backlogPolicy?: FieldWithSource<string>;
    /** Scholarships */
...
export interface AuditLog {
    ...
    id: string;
    /** Action type */
    action: 'job_created' | 'job_started' | 'job_completed' | 'job_failed' | 'data_fetched' | 'data_parsed' | 'data_validated' | 'diff_computed' | 'ai_verified' | 'data_published' | 'data_rejected' | 'manual_review';
    /** Entity type */

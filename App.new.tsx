            ...
            <div className="space-y-2">
              <button
                onClick={() => {
                  ...
                  const country = prompt('Enter country (Canada/UK):') as 'Canada' | 'UK';
                  if (university && country) {
                    createJobForUniversity(university, country);
                  }
                }}
                className="w-full px-4 py-2 bg-orange-600 text-white text-sm font-semibold rounded hover:bg-orange-700"
              >
                Create New Job
              </button>
            </div>
